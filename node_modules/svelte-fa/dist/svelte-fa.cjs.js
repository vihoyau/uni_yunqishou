...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			internal.attr(svg, "class", /*clazz*/ ctx[0]);
			internal.attr(svg, "style", /*s*/ ctx[9]);
			internal.attr(svg, "viewBox", svg_viewBox_value = `0 0 ${/*i*/ ctx[8][0]} ${/*i*/ ctx[8][1]}`);
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			internal.attr(path0, "d", path0_d_value = /*i*/ ctx[8][4][0]);
			internal.attr(path0, "fill", path0_fill_value = /*secondaryColor*/ ctx[4] || /*color*/ ctx[2] || "currentColor");

			internal.attr(path0, "fill-opacity", path0_fill_opacity_value = /*swapOpacity*/ ctx[7] != false
			? /*primaryOpacity*/ ctx[5]
			: /*secondaryOpacity*/ ctx[6]);

			internal.attr(path0, "transform", "translate(-256 -256)");
			internal.attr(path1, "d", path1_d_value = /*i*/ ctx[8][4][1]);
			internal.attr(path1, "fill", path1_fill_value = /*primaryColor*/ ctx[3] || /*color*/ ctx[2] || "currentColor");

			internal.attr(path1, "fill-opacity", path1_fill_opacity_value = /*swapOpacity*/ ctx[7] != false
			? /*secondaryOpacity*/ ctx[6]
			: /*primaryOpacity*/ ctx[5]);
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			internal.attr(path, "d", path_d_value = /*i*/ ctx[8][4]);
			internal.attr(path, "fill", path_fill_value = /*color*/ ctx[2] || /*primaryColor*/ ctx[3] || "currentColor");
