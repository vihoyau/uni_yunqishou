	...
	<view class="apply-commission-wrap page_box">
		...
		<view class="apply-form content_box">
			<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
				...
				<u-form-item :labelStyle="labelStyle" label-width="150" label-position="left" label="兼职/全职" prop="name">
					<u-input placeholder="请输入兼职/全职" :placeholderStyle="placeholderStyle" v-model="model.name" type="text"></u-input>
				</u-form-item>
				<u-form-item :labelStyle="labelStyle" prop="images" label="身份证正反面" label-position="top" label-width="150" :borderBottom="true">
					<u-upload
				...
				<u-form-item :labelStyle="labelStyle" 　 label-width="150" label-position="left" label="接单时间" prop="openhours">
					<u-input
						type="select"
				...
				<u-form-item :labelStyle="labelStyle" 　 label-width="150" label-position="left" label="接单天数" prop="weeks">
					<u-input type="select" placeholder="请选择接单天数" disabled :placeholderStyle="placeholderStyle" v-model="model.weeks" @click="onSelect('week')"></u-input>
				</u-form-item>
				...
				<u-form-item :labelStyle="labelStyle" label-width="150" label-position="left" label="居住地址" prop="address">
