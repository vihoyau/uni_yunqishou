...
<template>
	<view class="address-wrap">
		...
		<!-- 	<view class="address-box">
				...
				<u-form-item :labelStyle="labelStyle" label-width="150" label-position="left" label="收货定位:" prop="area_text">
					<u-input type="select" v-model="model.area_text" :select-open="showSelect" placeholder="收货定位" @tap="getLocation"></u-input>
				</u-form-item>
				<u-form-item :labelStyle="labelStyle" label-position="left" label-width="150" label="详细地址:" prop="address">
					<u-input border type="textarea" @tap="getLocation" v-model="model.address" placeholder="如道路、门牌号、小区、楼栋号、单元室等" />
				</u-form-item>
			</view>
			<br/> -->
			<!-- <view class="address-box">
				...
				<u-form-item :labelStyle="labelStyle" 　 label-width="150" label-position="left" label="备注:" prop="consignee">
					<u-input placeholder="备注" v-model="model.consignee" type="text"></u-input>
				</u-form-item>
				<u-form-item :labelStyle="labelStyle" 　 label-width="150" label-position="left" label="总价:" prop="phone">
					<u-input placeholder="待收取总价" v-model="model.phone" type="number"></u-input>
				</u-form-item>
			</view> -->
			<!-- 设置默认 -->
